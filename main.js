...
//HISTORY MAKING
//search old history: takes "searchTerm" and returns the info placed there in "oldHistory". if "searchTerm" is not in "oldHistory", returns null.
function searchOldHistory(searchTerm, oldHistory) {
    let lowerCase = oldHistory.toLowerCase(),
...
function multiTermSearch(searchTerm) {
    let searchTerms = Array.from(arguments);
    console.log(searchTerms);
}

multiTermSearch("hi", "hi again", "what's up");
...
function writeHistory() {
	...
	patient = {
		...
		healthProblems: searchOldHistory("*health problems*:", oldHistory),
		...
		diet: searchOldHistory("diet*: ", oldHistory),
	...
	defRabies = "#INPUT#['Is patient up-to-date on rabies vaccine?'/Up to date until #INPUT#/Not up to date, patient is exempt. See letter from rDVM./Not up to date, plan to vaccinate today/too young]",
    ...
    console.log(searchOldHistory("*medications*:", oldHistory));
    console.log(patient);
